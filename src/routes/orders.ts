...
router.get('/api/order', authenticationMiddleware, async (req: Request, res: Response) => {
...
router.post('/api/get-couriers', authenticationMiddleware, async (req: Request, res: Response) => {
...
router.post('/api/sort_couriers', authenticationMiddleware, async (req: Request, res: Response) => {
...
router.post('/api/generate-manifest', authenticationMiddleware, async (req: Request, res: Response) => {
  ...
  try {
    const results = await generateManifest(lineitems, supplierId, supplierName, supplierAddress, courierId, courierName, customer, orderId, shortLivedToken);
...
router.post('/api/generate-label', authenticationMiddleware, async (req: Request, res: Response) => {
